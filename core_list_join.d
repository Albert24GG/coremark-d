...
alias list_cmp = ee_s32 function(list_data* a, list_data* b, core_results* res);
...
ee_s16 calc_func(ee_s16* pdata, core_results* res)
{
    ...
    { /* otherwise calculate and cache the result */
        ...
        retval &= 0x007f;
        *pdata = cast(ee_s16)((data & 0xff00) | 0x0080 | retval); /* cache the result */
        return retval;
    }
}
...
ee_s32 cmp_idx(list_data* a, list_data* b, core_results* res)
{
    if (res == null)
    {
        a.data16 = cast(ee_s16)((a.data16 & 0xff00) | (0x00ff & (a.data16 >> 8)));
        b.data16 = cast(ee_s16)((b.data16 & 0xff00) | (0x00ff & (b.data16 >> 8)));
    }
    return a.idx - b.idx;
}
...
ee_u16 core_bench_list(core_results* res, ee_s16 finder_idx)
{
    ...
    list_head* this_find = void;
    list_head* finder = void, remover = void;
    list_data info = {0};
    ee_s16 i = void;
...
list_head* core_list_init(ee_u32 blksize, list_head* memblock, ee_s16 seed)
{
    ...
    ee_u32 per_item = 16 + list_data_s.sizeof;
    ...
    list_data* datablock = cast(list_data*)(memblock_end);
    list_data* datablock_end = datablock + size;
    /* some useful variables */
    ee_u32 i = void;
    list_head* finder = void, list = memblock;
    list_data info = void;
    ...
    list.info.data16 = cast(ee_s16) 0x8080;
    memblock++;
    datablock++;
    info.idx = 0x7fff;
    info.data16 = cast(ee_s16) 0xffff;
    ...
    for (i = 0; i < size; i++)
    {
        ee_u16 datpat = (cast(ee_u16)(seed ^ i) & 0xf);
        ee_u16 dat = cast(ee_u16)((datpat << 3) | (i & 0x7)); /* alternate between algorithms */
        info.data16 = cast(ee_s16)((dat << 8) | dat); /* fill the data with actual data and
    ...
    while (finder.next != null)
    {
        if (i < size / 5) /* first 20% of the list in order */
            finder.info.idx = cast(ee_s16)(i++);
        else
        {
            ee_u16 pat = cast(ee_u16)(i++ ^ seed); /* get a pseudo random number */
    ...
    static if (CORE_DEBUG)
    {
        ...
        {
            ee_printf(
                "[%04x,%04x]", finder.info.idx, cast(ee_u16) finder.info.data16);
            finder = finder.next;
        }
        ee_printf("\n");
    }
...
list_head* core_list_mergesort(list_head* list, list_cmp cmp, core_results* res)
{
    list_head* p = void, q = void, e = void, tail = void;
    ee_s32 insize = void, nmerges = void, psize = void, qsize = void, i = void;
